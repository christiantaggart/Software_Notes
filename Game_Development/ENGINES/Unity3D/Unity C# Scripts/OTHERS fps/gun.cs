// Advanced Gun - Single script that can create almost any standard weapon type. The demo is set up running a machine gun, 3 round burst rifle, shotgun, grenade launcher and rocket launcher.
...
mainCamera.GetComponent().offsetY = -kick;
...
newBullet.GetComponent().Owner = gunOwner; // owner of the bullet is this gun's owner object
