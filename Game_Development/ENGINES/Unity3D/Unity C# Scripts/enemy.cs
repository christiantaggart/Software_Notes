...
public class enemy : MonoBehaviour {
	...
	// 'BODY' == THE NAME I HAVE ASSAIGNED TO MY CLIENTS COMPONENT HOLDING ALL THE MESH COLLIDERS
	public GameObject body;



	void Start () {
		// THE MAIN CLIENT ENTITY
		CLIENT = GameObject.Find ("CLIENT").transform;
		anim = GetComponent<Animation> ();
		// SEE ABOVE COMMENT ON 'body'.. 'body' == component on client entity that houses my mesh &  mesh colliders
