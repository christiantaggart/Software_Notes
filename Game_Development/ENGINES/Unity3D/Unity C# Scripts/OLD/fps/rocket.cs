// Rocket - basic rocket script with slightly random per frame pathing for a more realistic and chaotic rocket.
...
ParticleEmitter emitter = (ParticleEmitter)GetComponentInChildren();
